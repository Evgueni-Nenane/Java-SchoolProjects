...
public class Produtor {
    ...
    public Produtor(int codigoProdutor, String nomeProdutor, String apelidoProdutor, String contactoProdutor, String emailProdutor) {
        this(nomeProdutor, apelidoProdutor, contactoProdutor, emailProdutor);
