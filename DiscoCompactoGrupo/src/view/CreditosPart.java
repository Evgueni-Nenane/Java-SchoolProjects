...
public class CreditosPart extends JDialog implements ActionListener, MouseListener {
	...
	public CreditosPart(ProdutorController produtorController, GravadoraController gravadoraController, EditoraController editoraController) {
		...
		gbcAC.fill = GridBagConstraints.HORIZONTAL;
		gbcAC.anchor = GridBagConstraints.WEST;
		gbcAC.gridx = 0;
		gbcAC.gridy = 0;
		...
		gbcAC.anchor = GridBagConstraints.EAST;
		gbcAC.gridx = 1;
		gbcAC.gridy = 0;
